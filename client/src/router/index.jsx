...
// // Guard component: renders children if role passes, else redirects to /dashboard
// const Guard = ({ roles, children }) => {
//   const { isAuthenticated, role } = useAuth()
//   if (!isAuthenticated) return <Navigate to="/login" replace />
//   if (roles && !roles.includes(role)) return <Navigate to="/dashboard" replace />
...
//         path: 'attendance/daily',
//         element: (
//           <Guard roles={['IT_ADMIN','HR_ADMIN','TIME_OFFICE']}>
//             <Wrap><DailyAttendance /></Wrap>
//           </Guard>
//         ),
//       },
//       {
...
//       {
//         path: 'employees',
//         element: <Wrap><EmployeesPage /></Wrap>,
//       },
//       {
//         path: 'employees/:empCode',
//         element: <Wrap><EmployeeDetailPage /></Wrap>,
//       },
...
//         path: 'monitoring/health',
//         element: (
//           <Guard roles={['IT_ADMIN']}>
//             <Wrap><SystemHealthPage /></Wrap>
//           </Guard>
//         ),
//       },
//       {
